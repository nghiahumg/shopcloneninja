...
2000000');
    ...
    // if($CMSNT->num_rows(" SELECT * FROM `addons` WHERE `id` = 12145 ") == 0){
    //     $CMSNT->insert("addons", [
    //         'id'            => 12145,
    //         'name'          => 'Template 5',
    //         'description'   => 'Giao diện bán sản phẩm #5',
    //         'image'         => 'https://i.imgur.com/Yd63czV.png',
    //         'createdate'    => '2022-09-7 00:00:00',
    //         'price'         => 500000,
    //         'purchase_key'  => ''
    //     ]);
    // }
    ...
    if($CMSNT->num_rows(" SELECT * FROM `addons` WHERE `id` = 11621 ") == 0){
        $CMSNT->insert("addons", [
            'id'            => 11621,
            'name'          => 'Tích hợp thuê OTP qua API chothuesimcode.com',
            'description'   => 'Chức năng thuê SIM tích hợp qua API chothuesimcode.com',
